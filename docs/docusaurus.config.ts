...
const config: Config = {
  title: 'React Native MultiDrawer',
  tagline: 'Multi-directional drawer components for React Native',
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'React Native MultiDrawer',
      logo: {
        alt: 'MultiDrawer Logo',
        src: 'img/drawer-logo.svg',
      },
      items: [
        {
          type: 'docSidebar',
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/react-native-multidrawer',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: 'npm',
              href: 'https://www.npmjs.com/package/react-native-multidrawer',
            },
          ],
        },
      ],
      copyright: `Copyright © ${new Date().getFullYear()} React Native MultiDrawer. Built with Docusaurus.`,
    },
    prism: {
